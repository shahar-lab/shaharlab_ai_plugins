...
Use the **`experiment-plan` skill** for all blueprint work. That skill defines the required file structure, formatting rules, section requirements, and create-vs-update logic. Read the skill (and its `blueprint-format.md`) before writing.
