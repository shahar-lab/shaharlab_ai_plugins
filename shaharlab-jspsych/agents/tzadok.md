...
| `manuscript-editor-baruch` | Writes the method section from completed experiment files | After experiment is finalized; invoke via `/manuscript-excerpt` |
