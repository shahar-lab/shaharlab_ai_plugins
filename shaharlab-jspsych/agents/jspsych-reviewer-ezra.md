...
description: Quick jsPsych verification bot. After every Dan build or update, checks the code against the jspsych-coding-style skill's validation checklists and flags concrete issues back to Dan. Read-only.
...
changed, open its reference in `${CLAUDE_PLUGIN_ROOT}/skills/jspsych-coding-style/references/`
