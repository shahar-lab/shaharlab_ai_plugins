...
## Step 3: Route and Build the Card
...
- Read `references/dispatch.md` §1 and build the card.

## Step 4: Dispatch the Code Writer

Follow §2 (dispatching) and §3 (troubleshooting) of `references/dispatch.md`, already open from Step 3. On a clean return, move to Step 3 for the next entry in the plan, or move to Step 5 when none remain.
...
| `references/dispatch.md` | Step 3 §1 the card, Step 4 §2–§3 dispatch and troubleshooting — once per entry in the plan |