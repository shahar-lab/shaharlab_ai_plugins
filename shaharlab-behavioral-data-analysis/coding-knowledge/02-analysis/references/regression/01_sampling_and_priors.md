...
**MANDATORY:** You must not run or compile a `brms` model until the user has explicitly approved the formula and the specific priors during the interview. Do not silently guess priors.
