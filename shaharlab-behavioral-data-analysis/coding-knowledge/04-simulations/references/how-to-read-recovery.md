...
`02-analysis/references/visualization/plot-types/` — `plot-posterior.md` for the population panels,
...
assembly follows `02-analysis/references/visualization/standards/PANEL_TAGGING_STANDARD.md` and
`EXPORT_STANDARD.md`.
