...
`02-analysis/visualization/plot-types/` — `plot-posterior.md` for the population panels,
...
assembly follows `02-analysis/visualization/standards/PANEL_TAGGING_STANDARD.md` and
`EXPORT_STANDARD.md`.
